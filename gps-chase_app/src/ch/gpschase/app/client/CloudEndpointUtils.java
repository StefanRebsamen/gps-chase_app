package ch.gpschase.app.client;
...
public class CloudEndpointUtils {
   ...
   * DevAppServer locally and the app on the phone).
   */
  protected static final String LOCAL_APP_ENGINE_SERVER_URL_PHONE = "http://192.168.0.20:8888";
   ...
   */
  protected static final String LOCAL_APP_ENGINE_SERVER_URL_EMULATOR = "http://10.0.2.2:8888";
  ...
  public static <B extends AbstractGoogleClient.Builder> B updateBuilder(
    ...
    if (LOCAL_ANDROID_RUN) {
      builder.setRootUrl(LOCAL_APP_ENGINE_SERVER_URL_PHONE
          + "/_ah/api/");
    }
