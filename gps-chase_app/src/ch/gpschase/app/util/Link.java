...
public class Link {
	 ...
	 * @return link
	 */
	public static Uri createDownloadLink(UUID trailUuid) {
		return new Uri.Builder().scheme(SCHEME).authority(AUTHORITY).appendPath("trail").appendPath(trailUuid.toString()).build();		
	}
